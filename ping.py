...
win.onkeypress(paddle_right_up,"e")
win.onkeypress(paddle_right_down,"d")
...
while True:
    ...
    if player_a_score==11:
        pen.clear()
        pen.write("A wins the game",align="center",font=('Monaco',30,"bold"))
        input()
        break
    if player_b_score==11:
        pen.clear()
        pen.write("B wins the game",align="center",font=('Monaco',30,"bold"))
        input()
        break
    ...
    if ball.xcor() > 400:   # right width paddle Border
        ball.goto(0,0)
        ball_dx = ball_dx * -1
    ...
    if(ball.xcor()) < -400: # Left width paddle Border
        ball.goto(0,0)
        ball_dx = ball_dx * -1
    ...
    if(ball.xcor() > 340) and (ball.xcor() < 360) and (ball.ycor() < paddle_right.ycor() + 40 and ball.ycor() > paddle_right.ycor() - 40):
        ball.setx(340)
        ball_dx = ball_dx * -1
        #os.system("afplay paddle.wav&")

    if(ball.xcor() < -340) and (ball.xcor() > -360) and (ball.ycor() < paddle_left.ycor() + 40 and ball.ycor() > paddle_left.ycor() - 40):
        ball.setx(-340)
        ball_dx = ball_dx * -1
        #os.system("afplay paddle.wav&") 
